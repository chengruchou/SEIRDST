...
parser.add_argument('--data', type=str, default=r'training_data/dataset_TN_2023_weekly_ext', help='data path')
parser.add_argument('--adjdata', type=str, default=r'training_data/out_graph_2023/adj_mat.pkl', help='adj data path')
