...
parser.add_argument('--save',type=str,default=r'test_dataset\test_result\test_result',help='save path')
...
def main():
    ...
    engine = trainer(scaler, args.in_dim, args.seq_length, args.num_nodes, args.nhid, args.dropout,
                         args.learning_rate, args.weight_decay, device, supports, args.gat_bool, args.addaptadj,
                         adjinit)
    ...
    for iter, (x, y) in enumerate(dataloader['test_loader'].get_iterator()):
        ...
        testx = testx.transpose(1,3)
        with torch.no_grad():
            tx = F.pad(testx, (engine.pad_t, 0, 0, 0))      # ★ 對齊訓練/驗證的左側 padding
            out, _ = engine.model(tx)                       # [N, 1, V, T]
